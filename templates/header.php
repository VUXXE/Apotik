...
<head>
    ...
    <link rel="stylesheet" href="/Apotik/assets/css/style.css">
    <style>
    ...
    <nav class="nav-neo">
        <div class="container nav-container" style="display: flex; align-items: center; justify-content: space-between; gap: 1rem;">
            ...
            <div style="display: flex; align-items: center; gap: 1.5rem; flex-shrink: 0;">
                <!-- Logo -->
                <a href="/Apotik/index.php" style="display: flex; align-items: center; gap: 0.5rem; flex-shrink: 0;">
                ...
                <!-- Navigation Links -->
                <div class="nav-links">
                    <a href="/Apotik/index.php" class="nav-link">Beranda</a>
                    
                    <?php if($is_logged_in): ?>
                        <?php if($is_admin): ?>
                            <a href="/Apotik/index.php#products" class="nav-link">Kategori</a>
                            <a href="#" class="nav-link">Promo</a>
                        <?php else: ?>
                            <a href="/Apotik/user/user_home.php" class="nav-link">Produk</a>
                            <a href="/Apotik/user/riwayat_pesanan.php" class="nav-link">Riwayat</a>
            ...
            <div class="search-container" style="flex: 1; max-width: 18rem; display: flex; justify-content: center; margin: 0 1rem;">
                <form action="<?= $is_logged_in && !$is_admin ? '/Apotik/user/user_home.php' : '/Apotik/index.php' ?>" method="GET" class="search-form" style="width: 100%; position: relative; display: flex; margin: 0;">
            ...
            <div style="display: flex; align-items: center; gap: 0.75rem; flex-shrink: 0;">
                <?php if($is_logged_in): ?>
                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                        <?php if(!$is_admin): ?>
                            <a href="/Apotik/user/cart.php" class="btn-neo btn-neo-sm bg-white" style="padding: 0.5rem 0.75rem; position: relative; margin: 0; margin-right: 0.25rem;">
                        ...
                        <?php else: ?>
                            <a href="/Apotik/admin/admin_dashboard.php?page=dashboard" class="btn-neo btn-neo-sm bg-yellow" style="margin: 0; font-weight: 900; font-size: 0.75rem; padding: 0.5rem 0.75rem; display: flex; align-items: center; gap: 0.35rem;">
                                <i class="fa-solid fa-gauge"></i> PANEL ADMIN
                            </a>
                        <?php endif; ?>
                        
                        <a href="/Apotik/auth/logout.php" class="btn-neo btn-neo-sm bg-black-flat" style="margin: 0;">
                            LOGOUT
                        </a>
                    </div>
                <?php else: ?>
                    <a href="/Apotik/auth/login.php" class="btn-neo btn-neo-sm bg-black-flat" style="margin: 0;">
                        MASUK
                    </a>
                <?php endif; ?>
            </div>
